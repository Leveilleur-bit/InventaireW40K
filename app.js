...
function ViewShame(_ref45) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onClick: function onClick() {
        return askConfirm("Marquer \"".concat(item.unit.name, "\" comme peint ?"), function () {
...
function ViewCodex(_ref47) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    x2: "12",
    y2: "3"
  })), "EXPORTER LA SAUVEGARDE"), /*#__PURE__*/React.createElement("input", {
    ref: importRef,
    type: "file",
    accept: ".json",
    style: {
...
function App() {
  ...
  var importData = function importData(file) {
    ...
    reader.onload = function (e) {
      try {
        ...
        askConfirm("Importer ".concat(next.inventory.length, " figurines et ").concat(next.lists.length, " listes ? Cela remplacera les donn\xE9es actuelles."), function () {
          setAppState(next);
          saveApp(next);
          setActiveView("lists");
  ...
  var deleteList = function deleteList(id) {
    return askConfirm("Supprimer cette liste ?", function () {
      return updateApp(function (s) {
        return _objectSpread(_objectSpread({}, s), {}, {
  ...
  var deleteEntry = function deleteEntry(listId, entryId) {
    return askConfirm("Retirer cette unité de la liste ?", function () {
      return updateApp(function (s) {
        return _objectSpread(_objectSpread({}, s), {}, {
          lists: s.lists.map(function (l) {
  ...
  var deleteInventory = function deleteInventory(id) {
    return askConfirm("Supprimer cette figurine de l'inventaire ?", function () {
      return updateApp(function (s) {
        return _objectSpread(_objectSpread({}, s), {}, {
  ...
  var deleteWish = function deleteWish(id) {
    return askConfirm("Retirer de la wishlist ?", function () {
      return updateApp(function (s) {
        return _objectSpread(_objectSpread({}, s), {}, {
  ...
  var deleteParade = function deleteParade(id) {
    return askConfirm("Supprimer cette photo ?", function () {
      return updateApp(function (s) {
        return _objectSpread(_objectSpread({}, s), {}, {
